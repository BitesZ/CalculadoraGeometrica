    ...
    <ScrollView style={styleCalculo.background}>
        <View style={styleCalculo.header}>
          <TouchableOpacity style={{position: 'absolute'}} onPress={() => router.back()}>
            ...
            <Text style={styleCalculo.headerText}>Retangulo</Text>
        </View>
        <View style={styleCalculo.contentContainer}>
          <Image style={styleCalculo.img} source={require("../assets/formulaRetangulo.jpg")}/>
          <TextInput style={styleCalculo.styleInput} placeholder='Lado H' keyboardType='numeric' value={ladoH} onChangeText={setLadoH}/>
